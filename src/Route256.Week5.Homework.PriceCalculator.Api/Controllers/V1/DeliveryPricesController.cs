...
using Route256.Week5.Homework.PriceCalculator.Bll.Queries.V1;
...
public class DeliveryPricesController : ControllerBase
{
    ...
    public async Task<DeleteHistoryResponse> DeleteHistory(
        DeleteHistoryRequest request,
        CancellationToken ct)
    {
        var query = new DeleteCalculationHistoryCommand(
            request.UserId,
